...
cout << "Snow depth for the first point is " << val1 << " meters" <<endl;
  //STUDENT: lookup the lat/lon for coordinates 40.1383, -105.1287
  double val2 = getSnowDepthValue(40.1383, -105.1287, data);
cout << "Snow depth for the second point is " << val2 << " meters" <<endl;
}